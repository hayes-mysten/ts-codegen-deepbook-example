...
export function BalanceManager() {
    return bcs.struct('BalanceManager', {
        id: object.UID(),
        owner: bcs.Address,
        balances: bag.Bag(),
...
export function BalanceManagerEvent() {
    return bcs.struct('BalanceManagerEvent', {
        balance_manager_id: bcs.Address,
        owner: bcs.Address
    });
}
export function BalanceEvent() {
    return bcs.struct('BalanceEvent', {
        balance_manager_id: bcs.Address,
...
export function TradeCap() {
    return bcs.struct('TradeCap', {
        id: object.UID(),
        balance_manager_id: bcs.Address
    });
}
export function DepositCap() {
    return bcs.struct('DepositCap', {
        id: object.UID(),
        balance_manager_id: bcs.Address
    });
}
export function WithdrawCap() {
    return bcs.struct('WithdrawCap', {
        id: object.UID(),
        balance_manager_id: bcs.Address
    });
}
export function TradeProof() {
    return bcs.struct('TradeProof', {
        balance_manager_id: bcs.Address,
        trader: bcs.Address
    });
}
...
export interface NewWithOwnerOptions {
    package?: string;
    arguments: NewWithOwnerArguments | [
        Owner: RawTransactionArgument<string>
    ];
}
...
export interface NewWithCustomOwnerOptions {
    package?: string;
    arguments: NewWithCustomOwnerArguments | [
        owner: RawTransactionArgument<string>
    ];
}
...
export interface MintTradeCapOptions {
    package?: string;
    arguments: MintTradeCapArguments | [
        balanceManager: RawTransactionArgument<string>
    ];
}
...
export interface MintDepositCapOptions {
    package?: string;
    arguments: MintDepositCapArguments | [
        balanceManager: RawTransactionArgument<string>
    ];
}
...
export interface MintWithdrawCapOptions {
    package?: string;
    arguments: MintWithdrawCapArguments | [
        balanceManager: RawTransactionArgument<string>
    ];
}
...
export interface RevokeTradeCapOptions {
    package?: string;
    arguments: RevokeTradeCapArguments | [
        balanceManager: RawTransactionArgument<string>,
        tradeCapId: RawTransactionArgument<string>
    ];
}
...
export interface GenerateProofAsOwnerOptions {
    package?: string;
    arguments: GenerateProofAsOwnerArguments | [
        balanceManager: RawTransactionArgument<string>
    ];
}
/**
...
export interface GenerateProofAsTraderOptions {
    package?: string;
    arguments: GenerateProofAsTraderArguments | [
        balanceManager: RawTransactionArgument<string>,
        tradeCap: RawTransactionArgument<string>
    ];
}
...
export interface ValidateProofOptions {
    package?: string;
    arguments: ValidateProofArguments | [
        balanceManager: RawTransactionArgument<string>,
        proof: RawTransactionArgument<string>
    ];
}
