...
export function OrderCanceled() {
    return bcs.struct('OrderCanceled', {
        balance_manager_id: bcs.Address,
        pool_id: bcs.Address,
        order_id: bcs.u128(),
        client_order_id: bcs.u64(),
...
export function OrderModified() {
    return bcs.struct('OrderModified', {
        balance_manager_id: bcs.Address,
        pool_id: bcs.Address,
        order_id: bcs.u128(),
        client_order_id: bcs.u64(),
...
export interface FilledQuantityOptions {
    package?: string;
    arguments: FilledQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
