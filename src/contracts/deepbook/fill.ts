...
export interface MakerOrderIdOptions {
    package?: string;
    arguments: MakerOrderIdArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface MakerClientOrderIdOptions {
    package?: string;
    arguments: MakerClientOrderIdArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface OriginalMakerQuantityOptions {
    package?: string;
    arguments: OriginalMakerQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface BaseQuantityOptions {
    package?: string;
    arguments: BaseQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface QuoteQuantityOptions {
    package?: string;
    arguments: QuoteQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface MakerDeepPriceOptions {
    package?: string;
    arguments: MakerDeepPriceArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface TakerFeeIsDeepOptions {
    package?: string;
    arguments: TakerFeeIsDeepArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface MakerFeeIsDeepOptions {
    package?: string;
    arguments: MakerFeeIsDeepArguments | [
        self: RawTransactionArgument<string>
    ];
}
