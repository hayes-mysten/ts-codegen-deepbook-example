...
export function OrderExpired() {
    return bcs.struct('OrderExpired', {
        balance_manager_id: bcs.Address,
        pool_id: bcs.Address,
        order_id: bcs.u128(),
        client_order_id: bcs.u64(),
...
export function poolId(options: PoolIdOptions) {
    ...
    const argumentsTypes = [
        `${packageAddress}::order_info::OrderInfo`
    ] satisfies string[];
...
export interface BalanceManagerIdOptions {
    package?: string;
    arguments: BalanceManagerIdArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface OriginalQuantityOptions {
    package?: string;
    arguments: OriginalQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface OrderDeepPriceOptions {
    package?: string;
    arguments: OrderDeepPriceArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface ExecutedQuantityOptions {
    package?: string;
    arguments: ExecutedQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface CumulativeQuoteQuantityOptions {
    package?: string;
    arguments: CumulativeQuoteQuantityArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface FillLimitReachedOptions {
    package?: string;
    arguments: FillLimitReachedArguments | [
        self: RawTransactionArgument<string>
    ];
}
...
export interface OrderInsertedOptions {
    package?: string;
    arguments: OrderInsertedArguments | [
        self: RawTransactionArgument<string>
    ];
}
